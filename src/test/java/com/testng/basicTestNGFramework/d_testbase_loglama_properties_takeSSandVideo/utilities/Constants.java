...
public class Constants
{
    ...
    public static final String WEBELEMENTS_PATH=
            "src/test/java/com/testng/basicTestNGFramework/d_testbase_loglama_properties_takeSSandVideo/webElements/webElements.properties";

    public static final String USER_DIR=System.getProperty("user.dir");
    public static final String TEST_OUTPUT_PATH=USER_DIR+"\\src\\test\\java\\com\\testng\\basicTestNGFramework\\d_testbase_loglama_properties_takeSSandVideo\\test-output\\";
