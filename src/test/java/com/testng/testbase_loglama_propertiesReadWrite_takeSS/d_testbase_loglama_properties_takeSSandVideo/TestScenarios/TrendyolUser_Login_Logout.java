package com.testng.testbase_loglama_propertiesReadWrite_takeSS.d_testbase_loglama_properties_takeSSandVideo.TestScenarios;


import com.testng.testbase_loglama_propertiesReadWrite_takeSS.d_testbase_loglama_properties_takeSSandVideo.utilities.TakeScreenShotsUtil;
...
import com.testng.testbase_loglama_propertiesReadWrite_takeSS.d_testbase_loglama_properties_takeSSandVideo.testbase.TestNG_TestBase_ForMultipleBrowsers04;

import static com.testng.testbase_loglama_propertiesReadWrite_takeSS.d_testbase_loglama_properties_takeSSandVideo.utilities.Constants.SCREENSHOTS_PATH;
...
import static com.testng.testbase_loglama_propertiesReadWrite_takeSS.d_testbase_loglama_properties_takeSSandVideo.utilities.WebElementUtil.getWebElement;
import static com.testng.testbase_loglama_propertiesReadWrite_takeSS.d_testbase_loglama_properties_takeSSandVideo.utilities.TakeScreenShotsUtil.*;
import static com.testng.testbase_loglama_propertiesReadWrite_takeSS.z_driver.DriverClass.getDriver;

public class TrendyolUser_Login_Logout extends TestNG_TestBase_ForMultipleBrowsers04
{
    ...
    public void navigateToURL(String URL, String country, String expectedTitle)
    {
        ...
        try
        {
            //URL'YE NAVIGATE ET
            getDriver().get(URL);
            TakeScreenShotsUtil.takeScreenshot(getDriver(), SCREENSHOTS_PATH,"CountrySelectPage",false);//can throw exception
            ...
            takeScreenshot(getDriver(), SCREENSHOTS_PATH,webElementName,false);//can throw exception

            takeScreenshot(countryDropDown, SCREENSHOTS_PATH,webElementName,false);//can throw exception
    ...
    public void loginTheAccount(@Optional("abc@gmail.com") String email, String password,String duration)
    {
        ...
        try
        {
            ...
            takeScreenshot(getDriver(), SCREENSHOTS_PATH,webElementName,false);
            ...
            Thread.sleep(2000);
            takeScreenshot(getDriver(), SCREENSHOTS_PATH,webElementName,true);
